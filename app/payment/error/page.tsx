      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-slate-500">
            Le paiement pour <span className="font-medium text-slate-700">{label}</span>
            {id && <> (#{id})</>} n&apos;a pas pu être traité.
          </p>
        </div>
        ...
        <p className="text-xs text-slate-400">
          Si le problème persiste, contactez le support via la section Tickets.
        </p>
      </div>
    </div>
  );
